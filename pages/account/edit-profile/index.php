...
//  -----------------------------------------------------
//  PAGE SPECIFIC DATA
define('PAGE_TITLE', 'Edit Your Account | Dealshare.ie');
define('PAGE_DESCRIPTION', 'Dealshare.ie | Edit Your Account details here, change your username, add your real name, add your social media links or give yourself an avatar.');
//  -----------------------------------------------------
            ...
            <div class="content-wrapper left span-12">
             	<?php include(DIR_TEMPLATES . '/temp_mobile_sidebar.php'); ?>
       			<div class="central-block" >
					...
					include(DIR_TEMPLATES . '/temp_account_edit-profile.php'); 
					?>
               	</div>
            </div>
