...
//  -----------------------------------------------------
if($tmp = $myUserManager -> GetWhere(array('id', 'hash', 'active'), array($USER_ID, $USER_HASH, 'yes'))) {
	$user = format($tmp[0]);
	$PAGE_ERROR = false;
	//
	define('PAGE_TITLE', 'Profile of ' . $user['name'] . ' | Dealshare.ie');
	define('PAGE_DESCRIPTION', 'Dealshare.ie | View this users details and the deals they have shared.');
}
else {
	$PAGE_ERROR = true;
	define('PAGE_TITLE', 'User Not Found | Dealshare.ie');
	define('PAGE_DESCRIPTION', 'Dealshare.ie | The Requested user could not be found.');
}
//  -----------------------------------------------------
        ...
        <div class="content-container clear">
            ...
            <div class="content-wrapper ">
        		...
        		<div class="central-block" >
                	<?php 
					include(DIR_TEMPLATES . '/temp_user_sidebar.php'); 
					include(DIR_TEMPLATES . '/temp_user_deals.php'); 
					?>
               	</div>
            </div>
