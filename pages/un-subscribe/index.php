...
//  -----------------------------------------------------
//  PAGE SPECIFIC DATA
define('PAGE_TITLE', 'Un-subscribe from Newsletter | Dealshare.ie');
define('PAGE_DESCRIPTION', 'Dealshare.ie | Un-subscribe from our newsletter.');
//  -----------------------------------------------------
        ...
        <div class="content-container clear">
            ...
            <div class="content-wrapper left span-12">
        		<div class="central-block" >
                	<?php 
					include(DIR_TEMPLATES . '/temp_unsubscribe.php'); 
					?>
               	</div>
            </div>
