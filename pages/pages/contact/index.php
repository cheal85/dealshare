...
//  -----------------------------------------------------
//  PAGE SPECIFIC DATA
define('PAGE_TITLE', 'Contact us | Dealshare.ie');
define('PAGE_DESCRIPTION', 'Dealshare.ie | Contact Dealshare.ie if you have any questions about our servide or how we provide it.  We would love to hear your feedback.');
//  -----------------------------------------------------
        ...
        <div class="content-container clear">
            ...
            <div class="content-wrapper ">
        		...
        		<div class="central-block">
                	<?php 
					include(DIR_TEMPLATES . '/temp_contact.php'); 
					?>
               	</div>
            </div>
