	...
	<div class="padding-10 ">
		<div class="">
			...
			<div id="account-main-top"  class="back-color-2 span-12 shadow" >
			   	<div class="padding-10">
					<h2 class="color-6">Supported Browsers</h2>
					<p class="color-6 medium">Download one of these supported browsers</p>
			    </div>
			</div>
			
			<div class="sep-20">&nbsp;</div>
			
			<div class="span-12 clear left shadow" >
				<div class="padding-20 clear " >
					
                    <div class="span-9 res centre  " >
                    	<h1>We support the below web browsers</h1>
                    </div>
